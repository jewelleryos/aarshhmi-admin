...
export function PricingRuleEditDrawer({
  rule,
  open,
  onOpenChange,
  categories,
  ...
  // Initialize form when rule changes or drawer opens
  useEffect(() => {
    if (rule && open) {
      setName(rule.name)
      // Convert conditions to ConditionState with generated IDs for UI tracking
      setConditions(
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Edit Pricing Rule</SheetTitle>
