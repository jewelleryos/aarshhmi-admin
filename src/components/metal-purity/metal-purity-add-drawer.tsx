...
import { createMetalPurity } from "@/redux/slices/metalPuritySlice"
...
interface MetalPurityAddDrawerProps {
  open: boolean
...
export function MetalPurityAddDrawer({ open, onOpenChange }: MetalPurityAddDrawerProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Metal purity created successfully")
      resetForm()
      onOpenChange(false)
    } catch (err) {
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Metal Purity</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Create a new purity level for metal types
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="name"
              placeholder="Enter metal purity name (e.g., 24 Karat)"
              value={name}
