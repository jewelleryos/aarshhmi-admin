...
import { createPearlType } from "@/redux/slices/pearlTypeSlice"
...
interface PearlTypeAddDrawerProps {
  open: boolean
...
export function PearlTypeAddDrawer({ open, onOpenChange }: PearlTypeAddDrawerProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Pearl type created successfully")
      resetForm()
      onOpenChange(false)
    } catch (err) {
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Pearl Type</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Create a new pearl type for jewellery products
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="name"
              placeholder="Enter pearl type name (e.g., Freshwater Pearl)"
              value={name}
          ...
          <div className="space-y-2">
            ...
            />
            {errors.slug && (
              <p className="text-sm text-destructive pl-1.25">{errors.slug}</p>
            )}
          </div>
