...
interface CollectionsAddDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  onSave: (collection: Omit<CollectionsItem, 'id'>) => Promise<void>
}

export function CollectionsAddDrawer({
  open,
  onOpenChange,
  onSave,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Add a new collection to the collections section
              </p>
            </div>
          </div>
        </SheetHeader>
