...
import type { FAQItem } from '@/components/cms/services/cmsService'

interface FAQAddDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  onSave: (item: Omit<FAQItem, 'id'>) => Promise<void>
}

export function FAQAddDrawer({ open, onOpenChange, onSave }: FAQAddDrawerProps) {
