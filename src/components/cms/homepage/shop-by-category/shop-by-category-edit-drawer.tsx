...
interface ShopByCategoryEditDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  category: ShopByCategoryItem | null
  onSave: (category: ShopByCategoryItem) => Promise<void>
}

export function ShopByCategoryEditDrawer({
  open,
  onOpenChange,
  category,
  onSave,
}: ShopByCategoryEditDrawerProps) {
  // Form state
