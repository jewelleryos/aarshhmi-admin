...
interface ShopByCategoryAddDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  onSave: (category: Omit<ShopByCategoryItem, 'id'>) => Promise<void>
}

export function ShopByCategoryAddDrawer({
  open,
  onOpenChange,
  onSave,
}: ShopByCategoryAddDrawerProps) {
  // Form state
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Add a new category to shop by category section
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <MediaPickerInput
            ...
            rootPath="cms/homepage/shop-by-category"
            required
