...
interface HeroMobileBannerAddDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  onSave: (banner: Omit<HeroMobileBannerItem, 'id'>) => Promise<void>
}

export function HeroMobileBannerAddDrawer({
  open,
  onOpenChange,
  onSave,
}: HeroMobileBannerAddDrawerProps) {
  // Form state
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Add a new hero banner for the mobile homepage
              </p>
            </div>
          </div>
        </SheetHeader>
