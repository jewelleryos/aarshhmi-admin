...
import type { HeroMobileBannerItem } from '@/components/cms/services/cmsService'

interface HeroMobileBannerEditDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  banner: HeroMobileBannerItem | null
  onSave: (banner: HeroMobileBannerItem) => Promise<void>
}

export function HeroMobileBannerEditDrawer({
  open,
  onOpenChange,
  banner,
  onSave,
}: HeroMobileBannerEditDrawerProps) {
  // Form state
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Update hero mobile banner details
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <MediaPickerInput
            ...
            rootPath="cms/homepage/hero-mobile-banner"
            required
