...
interface ProductRangeTableProps {
  ...
  onEdit: (category: ProductRangeItem) => void
    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h3 className="text-lg font-medium text-muted-foreground">
          No product range found
        </h3>
        <p className="text-sm text-muted-foreground mt-1">
          Click &quot;Add Product Range&quot; to create your first entry
        </p>
      </div>
    )
  }
  ...
  return (
    <>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete Product Range</AlertDialogTitle>
            <AlertDialogDescription>
              Are you sure you want to delete this product range? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
