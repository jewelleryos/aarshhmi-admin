...
interface ProductRangeAddDrawerProps {
  ...
  onSave: (category: Omit<ProductRangeItem, 'id'>) => Promise<void>
}

export function ProductRangeAddDrawer({
  open,
  onOpenChange,
  onSave,
}: ProductRangeAddDrawerProps) {
  // Form state
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Product Range</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Add a new entry to the product range section
              </p>
            </div>
          </div>
        </SheetHeader>
