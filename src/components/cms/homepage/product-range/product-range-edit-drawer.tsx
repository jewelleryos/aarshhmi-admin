...
interface ProductRangeEditDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  category: ProductRangeItem | null
  onSave: (category: ProductRangeItem) => Promise<void>
}

export function ProductRangeEditDrawer({
  open,
  onOpenChange,
  category,
  onSave,
}: ProductRangeEditDrawerProps) {
  // Form state
  ...
  const [errors, setErrors] = useState<{ title?: string; image_url?: string; redirect_url?: string }>({})
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Edit Product Range</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Update product range details
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="edit_title"
              placeholder="Enter product range title"
              value={title}
              onChange={(e) => {
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Describe the product range image"
              value={imageAltText}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="https://example.com/collections/rings"
              value={redirectUrl}
              onChange={(e) => {
