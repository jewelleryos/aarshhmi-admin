...
interface MediaGridAddDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  onSave: (item: Omit<MediaGridItem, 'id'>) => Promise<void>
}

export function MediaGridAddDrawer({
  open,
  onOpenChange,
  onSave,
}: MediaGridAddDrawerProps) {
  // Form state
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Add a new media item (image or video) for the grid
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="media_alt_text">Media Alt Text</Label>
            <Input
              id="media_alt_text"
