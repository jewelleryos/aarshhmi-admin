...
interface LuminiqueCollectionEditDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  item: LuminiqueCollectionItem | null
  onSave: (item: LuminiqueCollectionItem) => Promise<void>
}

export function LuminiqueCollectionEditDrawer({
  open,
  onOpenChange,
  item,
  onSave,
}: LuminiqueCollectionEditDrawerProps) {
  // Form state
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Edit Collection Item</SheetTitle>
