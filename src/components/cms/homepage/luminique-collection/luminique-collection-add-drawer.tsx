...
interface LuminiqueCollectionAddDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  onSave: (item: Omit<LuminiqueCollectionItem, 'id'>) => Promise<void>
}

export function LuminiqueCollectionAddDrawer({
  open,
  onOpenChange,
  onSave,
}: LuminiqueCollectionAddDrawerProps) {
  // Form state
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Collection Item</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Add a new item to the luminique collection
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <MediaPickerInput
            ...
            rootPath="cms/homepage/luminique-collection"
            required
          ...
          <div className="space-y-2">
            ...
            <Input
              id="redirect_url"
              placeholder="https://example.com/collections/luminique"
              value={redirectUrl}
              onChange={(e) => {
