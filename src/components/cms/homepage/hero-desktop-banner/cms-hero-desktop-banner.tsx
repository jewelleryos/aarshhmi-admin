...
import { cmsService, type HeroDesktopBannerItem, type HeroDesktopBannerContent } from '@/components/cms/services/cmsService'
...
export function CMSHeroDesktopBanner() {
