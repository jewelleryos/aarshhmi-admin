...
interface FilterChildEditDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  child: FilterChild | null
  groupName: string
  onSave: (child: FilterChild) => Promise<void>
}

export function FilterChildEditDrawer({
  open,
  onOpenChange,
  child,
  groupName,
  onSave,
}: FilterChildEditDrawerProps) {
    ...
    <Sheet open={open} onOpenChange={handleOpenChange}>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          {/* Redirect Link */}
          <div className="space-y-2">
            <Label htmlFor="edit_fc_redirectLink">Redirect Link</Label>
            <Input
              id="edit_fc_redirectLink"
          ...
          {/* Image Alt Text */}
          <div className="space-y-2">
            <Label htmlFor="edit_fc_imageAltText">Image Alt Text</Label>
            <Input
              id="edit_fc_imageAltText"
          ...
          {/* Rank */}
          <div className="space-y-2">
            <Label htmlFor="edit_fc_rank">Display Order</Label>
            <Input
              id="edit_fc_rank"
              type="number"
              min={0}
