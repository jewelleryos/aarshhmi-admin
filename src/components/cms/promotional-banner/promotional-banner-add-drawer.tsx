...
interface PromotionalBannerAddDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  onSave: (banner: Omit<PromotionalBannerItem, 'id'>) => Promise<void>
}

export function PromotionalBannerAddDrawer({
  open,
  onOpenChange,
  onSave,
}: PromotionalBannerAddDrawerProps) {
