...
import type { FAQsSectionItem, FAQType } from '@/redux/services/cmsService'
...
export function FAQsEditDrawer({
  open,
  onOpenChange,
  item,
  onSave,
  ...
  // Form state
  const [type, setType] = useState<FAQType>('orders')
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Lower numbers display first within the same type
            </p>
          </div>
