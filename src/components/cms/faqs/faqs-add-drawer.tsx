...
interface FAQsAddDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  onSave: (item: Omit<FAQsSectionItem, 'id'>) => Promise<void>
}

export function FAQsAddDrawer({ open, onOpenChange, onSave }: FAQsAddDrawerProps) {
