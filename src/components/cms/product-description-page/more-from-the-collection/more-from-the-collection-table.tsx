...
interface MoreFromTheCollectionTableProps {
  items: PromotionalBannerItem[]
  onEdit: (item: PromotionalBannerItem) => void
...
function createColumns(
  ...
  onDelete: (itemId: string) => void,
  onToggleStatus: (itemId: string) => void
): ColumnDef<PromotionalBannerItem>[] {
  return [
    {
      accessorKey: 'rank',
      header: ({ column }) => (
...
export function MoreFromTheCollectionTable({
  items,
  onEdit,
  onDelete,
  onToggleStatus,
}: MoreFromTheCollectionTableProps) {
