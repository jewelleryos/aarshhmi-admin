...
import type { DiamondEducationSection2Item } from '@/components/cms/services/cmsService'

interface Section2DrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  item: DiamondEducationSection2Item | null
  onSave: (
    item: Omit<DiamondEducationSection2Item, 'id'> | DiamondEducationSection2Item
  ) => Promise<void>
}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {isEditMode
                  ? 'Update the section 2 text item'
                  : 'Add a new text item to section 2'}
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <RichTextEditor
              ...
              mediaRootPath="cms/guide/diamond-education/section2"
            />
          </div>
        </div>
