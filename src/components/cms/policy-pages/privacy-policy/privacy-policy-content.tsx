...
import { cmsService, type PrivacyPolicyContent } from '@/redux/services/cmsService'
import { RichTextEditor } from '@/components/ui/rich-text-editor'

export function PrivacyPolicyContentComponent() {
  // Form state
  ...
  const fetchContent = async () => {
    try {
      ...
      const content = response.data?.content as PrivacyPolicyContent | undefined
      if (content) {
      ...
      <Card>
        <CardContent className="pt-6">
          <RichTextEditor
            ...
            mediaRootPath="cms/policy-pages/privacy-policy"
            error={error}
          />
        </CardContent>
      </Card>
