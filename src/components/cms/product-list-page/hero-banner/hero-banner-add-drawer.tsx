...
interface HeroBannerAddDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  onSave: (item: Omit<HeroBannerItem, 'id'>) => Promise<void>
}

export function HeroBannerAddDrawer({
  open,
  onOpenChange,
  onSave,
}: HeroBannerAddDrawerProps) {
      ...
      >
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Hero Banner</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Add a new hero banner for the product list page
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="hb-add-altText">Image Alt Text</Label>
            <Input
              id="hb-add-altText"
              value={imageAltText}
          ...
          <div className="space-y-2">
            <Label htmlFor="hb-add-redirectUrl">Redirect URL (Optional)</Label>
            <Input
              id="hb-add-redirectUrl"
              value={redirectUrl}
              onChange={(e) => {
          ...
          <div className="space-y-2">
            <Label htmlFor="hb-add-rank">Display Order</Label>
            <Input
              id="hb-add-rank"
              type="number"
              min={0}
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Label htmlFor="hb-add-status" className="cursor-pointer">Active</Label>
          </div>
        </div>
