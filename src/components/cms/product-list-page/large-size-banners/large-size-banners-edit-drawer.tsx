...
interface LargeSizeBannersEditDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  item: LargeSizeBannersItem | null
  onSave: (item: LargeSizeBannersItem) => Promise<void>
}

export function LargeSizeBannersEditDrawer({
  open,
  onOpenChange,
  item,
  onSave,
}: LargeSizeBannersEditDrawerProps) {
      ...
      >
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Edit Large Size Banner</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Update large size banner details
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="lsb-edit-altText">Image Alt Text</Label>
            <Input
              id="lsb-edit-altText"
              value={imageAltText}
          ...
          <div className="space-y-2">
            <Label htmlFor="lsb-edit-redirectUrl">Redirect URL</Label>
            <Input
              id="lsb-edit-redirectUrl"
              value={redirectUrl}
              onChange={(e) => {
          ...
          <div className="space-y-2">
            <Label htmlFor="lsb-edit-rank">Display Order</Label>
            <Input
              id="lsb-edit-rank"
              type="number"
              min={0}
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Label htmlFor="lsb-edit-status" className="cursor-pointer">Active</Label>
          </div>
        </div>
