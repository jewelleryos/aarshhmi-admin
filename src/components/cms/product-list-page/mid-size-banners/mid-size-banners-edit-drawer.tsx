...
interface MidSizeBannersEditDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  item: MidSizeBannersItem | null
  onSave: (item: MidSizeBannersItem) => Promise<void>
}

export function MidSizeBannersEditDrawer({
  open,
  onOpenChange,
  item,
  onSave,
}: MidSizeBannersEditDrawerProps) {
      ...
      >
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Edit Mid Size Banner</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Update mid size banner details
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="msb-edit-altText">Image Alt Text</Label>
            <Input
              id="msb-edit-altText"
              value={imageAltText}
          ...
          <div className="space-y-2">
            <Label htmlFor="msb-edit-redirectUrl">Redirect URL</Label>
            <Input
              id="msb-edit-redirectUrl"
              value={redirectUrl}
              onChange={(e) => {
          ...
          <div className="space-y-2">
            <Label htmlFor="msb-edit-rank">Display Order</Label>
            <Input
              id="msb-edit-rank"
              type="number"
              min={0}
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Label htmlFor="msb-edit-status" className="cursor-pointer">Active</Label>
          </div>
        </div>
