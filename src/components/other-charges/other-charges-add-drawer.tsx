...
import { createOtherCharge } from "@/redux/slices/otherChargeSlice"
import { toast } from "sonner"

interface OtherChargesAddDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
}

export function OtherChargesAddDrawer({ open, onOpenChange }: OtherChargesAddDrawerProps) {
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Other Charge</SheetTitle>
