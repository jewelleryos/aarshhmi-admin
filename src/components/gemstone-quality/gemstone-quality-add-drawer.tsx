...
import { createGemstoneQuality } from "@/redux/slices/gemstoneQualitySlice"
...
interface GemstoneQualityAddDrawerProps {
  open: boolean
...
export function GemstoneQualityAddDrawer({ open, onOpenChange }: GemstoneQualityAddDrawerProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Gemstone quality created successfully")
      resetForm()
      onOpenChange(false)
    } catch (err) {
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Gemstone Quality</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Create a new quality grade for gemstone products
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="name"
              placeholder="Enter quality name (e.g., AAA Grade)"
              value={name}
