...
import { createPearlQuality } from "@/redux/slices/pearlQualitySlice"
...
interface PearlQualityAddDrawerProps {
  open: boolean
...
export function PearlQualityAddDrawer({ open, onOpenChange }: PearlQualityAddDrawerProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Pearl quality created successfully")
      resetForm()
      onOpenChange(false)
    } catch (err) {
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Pearl Quality</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Create a new quality grade for pearl products
              </p>
            </div>
          </div>
        </SheetHeader>
