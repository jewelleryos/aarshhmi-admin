...
export function TagAddDrawer({ open, onOpenChange, tagGroups }: TagAddDrawerProps) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Create a new tag for organizing and filtering products
              </p>
            </div>
          </div>
        </SheetHeader>
