...
interface DiamondPricingUploadResultsProps {
...
export function DiamondPricingUploadResults({
  result,
  type,
}: DiamondPricingUploadResultsProps) {
                  ...
                  <TableBody>
                    {data.created.slice(0, 10).map((item) => (
                      <TableRow key={item.id}>
                        ...
                        <TableCell>{item.clarity_color}</TableCell>
            ...
            <TableBody>
              {errorData.errors.map((item, idx) => (
                <TableRow key={idx} className="bg-destructive/5">
                  ...
                  <TableCell>{item.data?.clarity_color || "-"}</TableCell>
