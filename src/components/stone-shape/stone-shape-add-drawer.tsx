...
import { createStoneShape } from "@/redux/slices/stoneShapeSlice"
...
interface StoneShapeAddDrawerProps {
  open: boolean
...
export function StoneShapeAddDrawer({ open, onOpenChange }: StoneShapeAddDrawerProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Diamond shape created successfully")
      resetForm()
      onOpenChange(false)
    } catch (err) {
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Diamond Shape</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Create a new diamond shape for jewellery products
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="name"
              placeholder="Enter shape name (e.g., Round Brilliant)"
              value={name}
