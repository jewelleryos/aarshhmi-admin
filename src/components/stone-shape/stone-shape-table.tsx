...
interface StoneShapeTableProps {
  items: StoneShape[]
  onEdit: (item: StoneShape) => void
  onDelete: (item: StoneShape) => void
  canUpdate: boolean
  canDelete: boolean
}
...
export function StoneShapeTable({
  items,
  onEdit,
  onDelete,
  canUpdate,
  canDelete,
}: StoneShapeTableProps) {
  // Memoize columns
    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Create your first diamond shape to get started
        </p>
      </div>
    )
  }
