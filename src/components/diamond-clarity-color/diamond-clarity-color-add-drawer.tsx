...
import { createDiamondClarityColor } from "@/redux/slices/diamondClarityColorSlice"
...
interface DiamondClarityColorAddDrawerProps {
  open: boolean
...
export function DiamondClarityColorAddDrawer({ open, onOpenChange }: DiamondClarityColorAddDrawerProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Diamond clarity/color created successfully")
      resetForm()
      onOpenChange(false)
    } catch (err) {
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Diamond Clarity/Color</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Create a new clarity/color grade for lab-grown diamond products
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="name"
              placeholder="Enter clarity/color name (e.g., VVS1 D)"
              value={name}
