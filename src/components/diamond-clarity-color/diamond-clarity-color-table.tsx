...
interface DiamondClarityColorTableProps {
  items: DiamondClarityColor[]
  onEdit: (item: DiamondClarityColor) => void
  onDelete: (item: DiamondClarityColor) => void
  canUpdate: boolean
  canDelete: boolean
}
...
export function DiamondClarityColorTable({
  items,
  onEdit,
  onDelete,
  canUpdate,
  canDelete,
}: DiamondClarityColorTableProps) {
  // Memoize columns
    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h3 className="text-lg font-medium text-muted-foreground">
          No diamond clarity/colors found
        </h3>
        <p className="text-sm text-muted-foreground mt-1">
          Create your first diamond clarity/color to get started
        </p>
      </div>
    )
  }
