...
interface GemstoneColorTableProps {
  items: GemstoneColor[]
  onEdit: (item: GemstoneColor) => void
  onDelete: (item: GemstoneColor) => void
  canUpdate: boolean
  canDelete: boolean
}
...
export function GemstoneColorTable({
  items,
  onEdit,
  onDelete,
  canUpdate,
  canDelete,
}: GemstoneColorTableProps) {
  // Memoize columns
    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h3 className="text-lg font-medium text-muted-foreground">
          No gemstone colors found
        </h3>
        <p className="text-sm text-muted-foreground mt-1">
          Create your first gemstone color to get started
        </p>
      </div>
    )
  }
