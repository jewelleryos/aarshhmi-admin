...
import { createGemstoneColor } from "@/redux/slices/gemstoneColorSlice"
...
interface GemstoneColorAddDrawerProps {
  open: boolean
...
export function GemstoneColorAddDrawer({ open, onOpenChange }: GemstoneColorAddDrawerProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Gemstone color created successfully")
      resetForm()
      onOpenChange(false)
    } catch (err) {
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Gemstone Color</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Create a new color option for gemstone products
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="name"
              placeholder="Enter color name (e.g., Deep Blue)"
              value={name}
