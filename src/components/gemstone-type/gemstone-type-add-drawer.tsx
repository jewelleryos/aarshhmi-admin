...
import { createGemstoneType } from "@/redux/slices/gemstoneTypeSlice"
...
interface GemstoneTypeAddDrawerProps {
  open: boolean
...
export function GemstoneTypeAddDrawer({ open, onOpenChange }: GemstoneTypeAddDrawerProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Gemstone type created successfully")
      resetForm()
      onOpenChange(false)
    } catch (err) {
      ...
      >
        ...
        <SheetHeader className="text-left px-6 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Gemstone Type</SheetTitle>
              <p className="text-sm text-muted-foreground">
                Create a new gemstone type for jewellery products
              </p>
            </div>
          </div>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="name"
              placeholder="Enter gemstone name (e.g., Ruby)"
              value={name}
